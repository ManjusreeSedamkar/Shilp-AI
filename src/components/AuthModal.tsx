...
import { sendPhoneOTP, verifyPhoneOTP, normalizePhoneNumber, signInWithUsernamePassword } from '../services/supabase';
        ...
        {authMode === 'login' ? (
          ...
          !otpSent ? (
            <form onSubmit={handleSendOtp} className="space-y-3 pt-1">
              ...
              <div>
                <label className="block text-xs font-semibold text-stone-700 mb-1">
                  Mobile Phone Number * <span className="text-[11px] font-normal text-stone-400">(e.g. 9063114094 → +919063114094)</span>
                </label>
                <div className="relative">
                  <Phone className="w-4 h-4 text-stone-400 absolute left-3 top-1/2 -translate-y-1/2" />
                  <input
