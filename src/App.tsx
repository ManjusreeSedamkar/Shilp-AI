...
// ── Firebase (legacy secondary fallback — kept until fully migrated) ─────────
import { fetchProductsFromFirestore } from './services/firebase';
...
export function App() {
  ...
  const [language, setLanguage] = useState<Language>(() => {
    try {
      const saved = localStorage.getItem('shilp_ai_preferred_language');
